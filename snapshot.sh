...
cp ~/.mantrachain/data/priv_validator_state.json  ~/.mantrachaind/priv_validator_state.json
...
cp ~/.mantrachain/priv_validator_state.json  ~/.mantrachaind/data/priv_validator_state.json
